...
ES6 provides a syntax to create objects using the class keyword. <br>

```js
// older way to create an object
// Here we're using a function to contruct the object 
var SpaceShuttle = function(targetPlanet) {
  this.targetPlanet = targetPlanet;
}
// we can instantiate an object using the new keyword
...
I'm storing the sample code in the [rock-paper-scissors](https://github.com/HeikoKramer/webDev/tree/main/tutorials/rock-paper-scissors) folder of this repo. <br>
