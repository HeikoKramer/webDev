...
* [Fonts](#fonts)
  ...
  + [font-weight & font-style](#font-weight--font-style)
* [Colors](#colors)
...
* [Box model, margin & padding](#box-model-margin--padding)
  + [Reset default styling](#reset-default-styling)
  + [Margin, padding and sizing properties](#margin-padding-and-sizing-properties)
* [Float & alignment](#float--alignment)
  + [Text align](#text-align)
  + [Floating](#floating)
* [Links & buttons](#links--buttons)
  + [link pseudo-selectors](#link-pseudo-selectors)
  + [style links and buttons](#style-links-and-buttons)
* [Navigation menu styling](#navigation-menu-styling)
  + [Side menu & navbar](#side-menu--navbar)
* [Inline & Block Styling](#inline--block-styling)
...
* [Responsive Design](#responsive-design)
  + [Practices to use](#practices-to-use)
  + [Media queries](#media-queries)
* [Em & Rem units](#em--rem-units)
  + [Em units](#em-units)
  + [Rem units](#rem-units)
* [vh & vw units](#vh--vw-units)
* [Flexbox](#flexbox)
  + [Alignment Properties](#alignment-properties)
  + [Flex basics](#flex-basics)
* [Flex alignment & order](#flex-alignment--order)
  + [justify-content](#justify-content)
  + [align-items](#align-items)
  + [align-content](#align-content)
  + [align-self](#align-self)
  + [order](#order)
* [background-color transparency](#background-color-transparency)
  + [Image only](#image-only)
  + [Image with transparent black overlay](#image-with-transparent-black-overlay)
* [Target selectors](#target-selectors)
  + [Direct childs](#direct-childs)
  + [Directly after](#directly-after)
  + [By attribute](#by-attribute)
* [nth-child Pseudo Selectors](#nth-child-pseudo-selectors)
  + [styling by number](#styling-by-number)
  + [repetitive styling](#repetitive-styling)
  + [every odd](#every-odd)
  + [every even](#every-even)
* [before & after pseudo selectors](#before--after-pseudo-selectors)
  + [after](#after)
  + [before](#before)
* [box-shadow](#box-shadow)
  + [offset-x | offset-y | color](#offset-x--offset-y--color)
  ...
  + [inset | offset-x | offset-y | color](#inset--offset-x--offset-y--color)
  + [multiple shadows](#multiple-shadows)
* [text-shadow](#text-shadow)
* [css variables](#css-variables)
* [Keyframe animation](#keyframe-animation)
* [Time-step animations](#time-step-animations)
...
* [Transform](#transform)
  ...
  + [translate](#translate)
* [CSS Grid](#css-grid)
  + [Difference between flex and grid](#difference-between-flex-and-grid)
  + [Grid columns](#grid-columns)
  + [The fr unit](#the-fr-unit)
  + [grid-gap](#grid-gap)
  + [sidebar example](#sidebar-example)
* [Grid rows](#grid-rows)
  + [multi dimensional grid](#multi-dimensional-grid)
* [Spanning columns & rows](#spanning-columns--rows)
* [auto-fit & minmax](#auto-fit--minmax)
* [Grid template areas](#grid-template-areas)
* [Grid media queries](#grid-media-queries)
  + [media queries with grid-template-areas](#media-queries-with-grid-template-areas)
* [Sass](#sass)
  + [.scss vs .sass](#scss-vs-sass)
* [Environment setup with Node-Sass](#environment-setup-with-node-sass)
* [Variables & partials](#variables--partials)
* [Nesting & structuring](#nesting--structuring)
* [@extend](#extend)
